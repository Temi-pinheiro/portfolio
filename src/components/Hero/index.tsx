    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col mt-8 md:mt-[116px] max-w-[486px] gap-y-5">
          ...
          >
            A multidiscplinary software developer that builds with the user at
            heart and business in mind. Currently building the social media for
            humanity @
            <a
              className="text-[#adec76] underline underline-offset-4"
              href="https://kommunne.com/"
              target="_blank"
            >
              Kommunne
            </a>
